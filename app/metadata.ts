...
export function generateMetadata(title: string, description?: string): Metadata {
    ...
    const baseDescription = 'Chiro Houthulst is een jeugdbeweging in Houthulst. Elke zondag van 14u tot 17u is er chiro voor alle kinderen vanaf het derde kleuter. Ook organiseren we tal van andere activiteiten zoals weekends, kamp, fuiven ...';
    ...
    return {
        ...
        icons: [
            ...
            {rel: 'mask-icon', url: 'icons/safari-pinned-tab.svg', color: '#104f29'},
        ],
